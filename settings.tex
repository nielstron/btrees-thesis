...
\usepackage{caption}
\usepackage{amsmath} % for own functions, needs to be imported before cleveref
\usepackage[hidelinks]{hyperref} % hidelinks removes colored boxes around references and links
\usepackage[nameinlink]{cleveref} % nameinlink makes the name of the reference i.e. "Section" clickable
...
\DeclareMathOperator{\lsplitfun}{linear\_split}
\DeclareMathOperator{\takewhile}{takeWhile}
\DeclareMathOperator{\dropwhile}{dropWhile}
...
\DeclareMathOperator{\delfun}{del}
