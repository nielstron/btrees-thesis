...
In \Cref{chapter:introduction}, we introduce B-Trees and common variations
on them.
...
and the set.
In this work, we will start at the definition with lists in \Cref{chapter:abs-set}
