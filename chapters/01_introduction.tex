...
us with a given splitting, it is safe to limit the recursive considerations
to the part on the right side of the split.
Note that this always also includes the last tree of the node, i.e. even if $rs$ is empty.
